<div class="row">
	...
	<?php echo form_open(site_url("customer/insert"), array('class' => 'form-horiontal', 'id' => 'add_package')); ?>
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-4">
					<div class="input-group bootstrap-timepicker">
						<input name="births" type="text" class="form-control date-picker" placeholder="Ex : <?php echo date('Y-m-d') ?>"  />
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-10">
		      		<textarea name="address" class="form-control" id="" cols="3" rows="4"></textarea>
		    	</div>
		  	</div>
			  <div class="col-md-12">
