...
<?php 
echo form_open(site_url("master/bulkpackage"), array('class' => 'form-horiontal', 'id' => 'add_package')); 
	if(is_array($this->input->post('package'))) :
		foreach($this->input->post('package') as $key => $value) :
			$get = $this->package->get($value);
			echo form_hidden('packages[]', $get->package_ID);
?>
			  ...
			  <div class="col-md-12">
				<div class="clearfix form-actions">
					<div class="col-md-offset-4 col-md-9">
						<button class="btn btn-info" type="submit" value="update" name="action">
...
<?php
/* End of file multiple_update_package.php */
/* Location: ./application/modules/Master/views/multiple_update_package.php */
