<div class="row">
	...
	<?php echo form_open(site_url("master/insertpackage"), array('class' => 'form-horiontal', 'id' => 'add_package')); ?>
		...
		?>
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-4">
					<div class="input-group bootstrap-timepicker">
						<input name="duration" id="timepicker1" type="text" class="form-control" placeholder="Ex : 01:30:00" required="" />
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-10">
		      		<input type="text" name="price" id="input" class="form-control" value="" placeholder="Ex : 100000" required="">
		    	</div>
		  	</div>
		  	<div class="form-group col-md-12">
